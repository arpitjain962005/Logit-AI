...
const signals = [
  { title: "Successful Runs", value: "+6%", desc: "improved by 6% this week", color: "green" },
  { title: "Pounds in Transit", value: "+8%", desc: "increased by 8% MoM", color: "yellow" },
  { title: "Route C Cut", value: "+3.4%", desc: "improved by 3.4% after optimization", color: "green" },
  { title: "Arthur's Runs", value: "Top 5%", desc: "above network average", color: "blue" },
];
      ...
      <div className="max-w-7xl mx-auto pb-20">
        <div className="mb-8">
          <h1 className="text-2xl font-serif font-semibold text-white tracking-tight flex items-center gap-3">
            ...
            The Takings & Good News
          </h1>
          <p className="text-slate-400 mt-2 font-serif italic">Key areas of operational improvement and revenue growth.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {signals.map((signal, i) => (
            <motion.div
              ...
              className="relative p-6 rounded-2xl bg-[#1C1918]/90 backdrop-blur-md border border-white/5 hover:border-green-500/30 transition-all duration-300 group overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.2)]"
            >
              ...
              <h3 className="text-sm font-serif font-medium text-slate-400 mb-4">{signal.title}</h3>
